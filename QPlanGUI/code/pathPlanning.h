...
/*
* 分布式人为干预下的点对点运动规划函数 distributedMotionPlanningHuman
* -功能：分布式搜索运动规划
* -输入：
*		PathInfo * 代表规划好的路径
...
_LIB_PATHPLAN_API int distributedMotionPlanningHuman(
	PathInfo *res,
	const PointTask targetLocation,
...
*							其他编号代表错误类型
*/
_LIB_PATHPLAN_API int  distributedSearchMotionPlanningHuman(
	PathInfo *res,
